...
resource "aws_alb_listener_rule" "domain_http" {
  count        = var.setup_listener_rule && var.enable_http_rules && var.setup_target_group ? ceil(length(var.domains) / 5) : 0
...
resource "aws_alb_listener_rule" "domain_http_custom" {
  count        = var.setup_listener_rule && var.enable_http_rules && var.setup_target_group == 0 ? ceil(length(var.domains) / 5) : 0
  listener_arn = var.alb_listener_http_arn
  priority     = var.domain_priority_init + count.index
...
resource "aws_alb_listener_rule" "cognito_domain_http" {
  count        = var.setup_listener_rule && var.enable_http_rules && var.setup_target_group ? ceil(length(var.cognito_domains) / 5) : 0
  listener_arn = var.alb_listener_http_arn
...
resource "aws_alb_listener_rule" "cognito_domain_http_custom" {
  count        = var.setup_listener_rule && var.enable_http_rules && var.setup_target_group == 0 ? ceil(length(var.cognito_domains) / 5) : 0
  listener_arn = var.alb_listener_http_arn
  priority     = var.cognito_domain_priority_init + count.index
...
resource "aws_alb_listener_rule" "url_http" {
  count        = var.setup_listener_rule && var.enable_http_rules && var.setup_target_group ? ceil(length(var.urls) / 5) : 0
  listener_arn = var.alb_listener_http_arn
...
resource "aws_alb_listener_rule" "url_http_custom" {
  count        = var.setup_listener_rule && var.enable_http_rules && var.setup_target_group == 0 ? ceil(length(var.urls) / 5) : 0
  listener_arn = var.alb_listener_http_arn
  priority     = var.url_priority_init + count.index
...
resource "aws_alb_listener_rule" "cognito_url_http" {
  count        = var.setup_listener_rule && var.enable_http_rules && var.setup_target_group ? ceil(length(var.cognito_urls) / 5) : 0
  listener_arn = var.alb_listener_http_arn
...
resource "aws_alb_listener_rule" "cognito_url_http_custom" {
  count        = var.setup_listener_rule && var.enable_http_rules && var.setup_target_group == 0 ? ceil(length(var.cognito_urls) / 5) : 0
  listener_arn = var.alb_listener_http_arn
  priority     = var.cognito_url_priority_init + count.index
