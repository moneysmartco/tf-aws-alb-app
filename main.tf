...
module "alb_listener_rule" {
  ...
  setup  = "${var.setup_listener_rule}"
  app_target_group_arn    = "${var.setup_target_group ? module.target_group.target_group_arn : var.app_target_group_arn}"
